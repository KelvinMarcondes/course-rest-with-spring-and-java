package com.marcondes.courserestjava.section06.math.controller;

import com.marcondes.courserestjava.section06.math.converters.NumberConverter;
import com.marcondes.courserestjava.section06.math.exceptions.UnsupportedMathOperationException;
import com.marcondes.courserestjava.section06.math.math.SimpleMath;
...
public class MathController {
    ...
    public Double mult(@PathVariable(value = "numberOne") String numberOne,
        ...
        return math.mult(NumberConverter.convertDouble(numberOne), NumberConverter.convertDouble(numberTwo));
    }
